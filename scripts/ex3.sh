...
docker create --link db:db  --name wordpress -p  8081:80 -e ALLOW_EMPTY_PASSWORD=yes  -e WORDPRESS_DATABASE_USER=wordpress  -e WORDPRESS_DATABASE_NAME=wordpress -v datos:/workspace/ mgreyes/nginx-wordpress
